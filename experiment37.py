...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\user\\Downloads\\user bpm10\\psychopy\\N-Back\\ColourTesting_lastrun.py',
...
#     pathNeg = r'C:\Users\NU\Desktop\freelance\project2\N-Back\BPM\user bpm10\Negative Pictures\Selected N'
#     pathPos = r'C:\Users\NU\Desktop\freelance\project2\N-Back\BPM\user bpm10\Positive Pictures\selected p'
...
#     sound_happy = r'C:\Users\NU\Desktop\freelance\project2\N-Back\BPM\user bpm10\Music\Happy.ogg'
#     sound_sad =   r'C:\Users\NU\Desktop\freelance\project2\N-Back\BPM\user bpm10\Music\Sad.ogg'
...
def runRoutineTwoBack ():
    pathNeg = r'C:\Users\user\Downloads\experiment2_fixed_order\user bpm10\Negative Pictures\Selected N'
    pathPos = r'C:\Users\user\Downloads\experiment2_fixed_order\user bpm10\Positive Pictures\selected p'
    negative_images = os.listdir (pathNeg)
    positive_images = os.listdir (pathPos)
    negative_images = [os.path.join(pathNeg, image) for image in negative_images]
    positive_images = [os.path.join(pathPos, image) for image in positive_images]
    sound_happy = r'C:\Users\user\Downloads\experiment2_fixed_order\user bpm10\Music\Happy.ogg'
    sound_sad = r'C:\Users\user\Downloads\experiment2_fixed_order\user bpm10\Music\Sad.ogg'
...
def runRoutineOneBack (music_type):
    ...
    #return 0
    all_letters = list (data_exp ['numbers'])
    print ('letters:', all_letters,' len:', len (all_letters))
    #return 0
    #for thisBlock1_1back in Block1_1back:
    #   all_letters.append (thisBlock1_1back ['colourtest'])
    iteration = -1
    ...
    for thisBlock1_1back in Block1_1back:
        ...
        letters_l.append (all_letters[iteration])
        key_rt.append (key_resp_3.rt)
    ...
    df = pd.DataFrame ({'stimuli':letters_l,'response time':key_rt,'bpms':bpms, 'key_resp':key_resp, 'fix_started':fix_started,'fix_end':fix_end, 'correctness':correct, 'sound':sound_l, 'difficulty':diff})
    # get names of stimulus parameters
    if Block1_1back.trialList in ([], [None], None):
        params = []
    else:
    ...
    if (music_type =='sad'):
        df.to_excel ('data/experiment1_sad.xlsx')
        ...
        df.to_excel ('data/experiment1_happy.xlsx')
...
def runRoutineTwoBackUpd (music_type):
    ...
    # save data for this loop
    if (music_type =='sad'):
        df.to_excel ('data/experiment2_sad.xlsx')
        ...
        df.to_excel ('data/experiment2_happy.xlsx')
...
def runRoutineThreeBackUpd (music_type):
    ...
    # save data for this loop
    if (music_type == 'sad'):
        df.to_excel ('data/experiment3_sad.xlsx')
        ...
        df.to_excel ('data/experiment3_happy.xlsx')
