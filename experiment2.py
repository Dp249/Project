...
text_4 = visual.TextStim(win=win, name='text_4',
    text='Hello and welcome to the cognitive task. Will show negative and posittive images\n with two conditions \n We will inform you about the new rule.\nPress space to continue.',
    font='Arial',
...
text = visual.TextStim(win=win, name='text',
    text='This is the experiment to test the effect of happy/sad stimuli to person`s emotional state. You will be shown a series of images with the background music. \n\nPress space to begin. \n\n pictures will start fater 30 seconds ',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0,
    color='white', colorSpace='rgb', opacity=1,
    languageStyle='LTR',
...
text_response = visual.TextStim(win=win, name='text_response',
    text="Please rate the complexity of the previous task from 1 to 7",
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0,
    color='white', colorSpace='rgb', opacity=1,
    languageStyle='LTR',
...
def runRoutineOne ():
    ...
    while (not finishedCalibration):
        ...
        #     else:
        #         finishedCalibration = False
    stim, snd = negative_images [0]
    mySound = sound.Sound(snd)
    mySound.play ()
    for list_of_stimuli in [negative_images]:
    ...
    message.text = "Please rate how Negative/Positive pictures are"
...
def runRoutineTwo ():
    ...
    mySound.stop()
    message = visual.TextStim(win=win, alignHoriz='center', pos=(0,0.75))
    message.text = "Please rate how Negative/Positive the pictures are"
    scales = '1=Low                      7=High'
    ratingScale = visual.RatingScale(win=win, pos=(0,-0.75), scale=scales, size=0.75, stretch=1.5)
    while ratingScale.noResponse:
        message.draw()
    ...
    rating_list = [rating] * len (hr)
    df = DataFrame({'Heart Rate': hr, 'Stimuli Type': st, 'Difficulty Rating':rating_list})
    df.to_excel('positive_heart_rate.xlsx', sheet_name='One', index=False)
    return 0
...
def runRoutineTwoBack ():
    ...
    Block2_2back = data.TrialHandler(nReps=1, method='random',
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('2_back_test.xlsx'),
    ...
    all_letters = []
    data_exp = pd.read_excel('2_back_test.xlsx')
    print (data_exp.head())
    #return 0
    all_letters = list (data_exp ['numbers'])
    print ('letters:', all_letters)
    ...
    # ------Prepare to start Routine "Response"-------
    message = visual.TextStim(win=win, alignHoriz='center', pos=(0,0.75))
    message.text = "Please rate the Negative/Positive the pictures are"
    scales = '1=Low                       7=High'
    ratingScale = visual.RatingScale(win=win, pos=(0,-0.75), scale=scales, size=0.75, stretch=1.5)
    while ratingScale.noResponse:
        message.draw()
...
def runRoutineThreeBack ():
    ...
    Block3_3back = data.TrialHandler(nReps=1, method='random',
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('3_back_test.xlsx'),
    ...
    all_letters = []
    data_exp = pd.read_excel('3_back_test.xlsx')
    print (data_exp.head())
    #return 0
    ...
    # ------Prepare to start Routine "Response"-------
    message = visual.TextStim(win=win, alignHoriz='center', pos=(0,0.75))
    message.text = "Please rate how Negative/Picture are"
    scales = '1=Low                       7=High'
    ratingScale = visual.RatingScale(win=win, pos=(0,-0.75), scale=scales, size=0.75, stretch=1.5)
    while ratingScale.noResponse:
        message.draw()
