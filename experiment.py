...
expName = "N-Back task"  # from the Builder filename that created this script
...
text = visual.TextStim(
    win=win,
    name="text",
    text="This is the 1-back test. You will have to press space if you decide the previous number   was the same as the current one.\n\nPlease press space only when you decide the number was repeated. Press space to begin.",
    font="Arial",
    pos=(0, 0),
    height=0.1,
    wrapWidth=None,
...
text_5 = visual.TextStim(
    win=win,
    name="text_5",
    text="This is the 2-back test. You will have to press space if you decide the number two trials ago was the same as the current one.\n\nPlease press space only when you decide the number was repeated. Press space to begin.",
    font="Arial",
    pos=(0, 0),
    height=0.1,
    wrapWidth=None,
...
text_6 = visual.TextStim(
    win=win,
    name="text_6",
    text="This is the 3-back test. You will have to press space if you decide the number three trials ago was the same as the current one.\n\nPlease press space only when you decide the number was repeated. Press space to begin.",
    font="Arial",
    pos=(0, 0),
    height=0.1,
    wrapWidth=None,
...
def runRoutineOneBack():
    ...
    Block1_1back = data.TrialHandler(
        nReps=1,
        method="random",
        extraInfo=expInfo,
        originPath=-1,
    ...
    thisBlock1_1back = Block1_1back.trialList[
        0
    ...
    for thisBlock1_1back in Block1_1back:
        ...
        # text_7.setText(thisBlock1_1back ['numbers'])
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if key_resp_3.status == STARTED and not waitOnFlip:
                ...
                if len(_key_resp_3_allKeys):
                    key_resp_3.keys = [
                        key.name for key in _key_resp_3_allKeys
                    ]  # storing all keys
            ...
            print(
                all_letters[iteration],
                " ",
                all_letters[iteration - 1],
                all_letters[iteration - 1] != all_letters[iteration],
                iteration - 1,
            )
            # mySound = sound.Sound('A')
            if (
                "space" in key_resp_3.keys
                and flag == False
                and iteration > 0
                and iteration < len(all_letters)
                and all_letters[iteration] != all_letters[iteration - 1]
            ):
    ...
    while continueRoutine:
        ...
        if key_resp_4.status == STARTED and not waitOnFlip:
            ...
            if len(_key_resp_4_allKeys):
                key_resp_4.keys = _key_resp_4_allKeys[
                    -1
                ].name  # just the last key pressed
    ...
    scales = "1=Easy                       7=Very Difficult"
    ratingScale = visual.RatingScale(
        win=win, pos=(0, -0.75), scale=scales, size=0.75, stretch=1.5
    )
    ...
    df.to_excel("data/1Back")

    Block1_1back.saveAsExcel(
        filename + "Block1_1back.xlsx",
        sheetName="Block1_1back",
        stimOut=params,
        dataOut=["n", "all_mean", "all_std", "all_raw"],
    )
    Block1_1back.saveAsText(
        filename + "Block1_1back.csv",
        delim=",",
        stimOut=params,
        dataOut=["n", "all_mean", "all_std", "all_raw"],
    )
...
def runRoutineTwoBack():
    ...
    while continueRoutine:
        ...
        if key_resp_6.status == STARTED and not waitOnFlip:
            ...
            if len(_key_resp_6_allKeys):
                key_resp_6.keys = _key_resp_6_allKeys[
                    -1
                ].name  # just the last key pressed
    ...
    # set up handler to look after randomisation of conditions etc
    Block2_2back = data.TrialHandler(
        nReps=1,
        method="random",
        extraInfo=expInfo,
        originPath=-1,
    ...
    thisBlock2_2back = Block2_2back.trialList[
        0
    ]  # so we can initialise stimuli with some values
    ...
    for thisBlock2_2back in Block2_2back:
        ...
        routineTimer.add(1.000000)
        # update component parameters for each repeat
        # text_7.setText(thisBlock2_2back['numbers'])
        if iteration >= len(all_letters):
            break
        curr_letter = all_letters[iteration]
        # text_7.setText(thisBlock1_1back ['numbers'])
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if (
                ...
                and iteration > 1
                and iteration < len(all_letters)
                and all_letters[iteration] != all_letters[iteration - 2]
            ):
                print(all_letters[iteration], " ", all_letters[iteration - 1])
                nextFlip = win.getFutureFlipTime(clock="ptb")
                mySound.play(when=nextFlip)  # sync with screen refresh
        ...
        if process.bpms.__len__() > 50:
            if (
                max(process.bpms - np.mean(process.bpms)) < 5
            ):  # show HR if it is stable -the change is not over 5 bpm- for 3s
                print("current bpm:", " ", bpm)
        # -------Ending Routine "trial"-------
        for thisComponent in trialComponents:
    ...
    # save data for this loop
    df.to_excel("data/2Back")

    Block2_2back.saveAsExcel(
        filename + "Block2_2back.xlsx",
        sheetName="Block2_2back",
        stimOut=params,
        dataOut=["n", "all_mean", "all_std", "all_raw"],
    )
    Block2_2back.saveAsText(
        filename + "Block2_2back.csv",
        delim=",",
        stimOut=params,
        dataOut=["n", "all_mean", "all_std", "all_raw"],
    )
...
def runRoutineThreeBack():
    ...
    while continueRoutine:
        ...
        if key_resp_7.status == STARTED and not waitOnFlip:
            ...
            if len(_key_resp_7_allKeys):
                key_resp_7.keys = _key_resp_7_allKeys[
                    -1
                ].name  # just the last key pressed
    ...
    # set up handler to look after randomisation of conditions etc
    Block3_3back = data.TrialHandler(
        nReps=1,
        method="random",
        extraInfo=expInfo,
        originPath=-1,
    ...
    thisBlock3_3back = Block3_3back.trialList[
        0
    ]  # so we can initialise stimuli with some values
    ...
    for thisBlock3_3back in Block3_3back:
        ...
        # text_7.setText(thisBlock1_1back ['numbers'])
        text_7.setText(curr_letter)
        # text_7.setText(thisBlock3_3back['numbers'])
        key_resp_3.keys = []
        key_resp_3.rt = []
        _key_resp_3_allKeys = []
        # keep track of which components have finished
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if (
                ...
                and iteration > 2
                and iteration < len(all_letters)
                and all_letters[iteration] != all_letters[iteration - 3]
            ):
                print(all_letters[iteration], " ", all_letters[iteration - 1])
                nextFlip = win.getFutureFlipTime(clock="ptb")
                mySound.play(when=nextFlip)  # sync with screen refresh
    ...
    # save data for this loop
    df.to_excel("data/3Back")
    Block3_3back.saveAsExcel(
        filename + "Block3_3back.xlsx",
        sheetName="Block3_3back",
        stimOut=params,
        dataOut=["n", "all_mean", "all_std", "all_raw"],
    )
    Block3_3back.saveAsText(
        filename + "Block3_3back.csv",
        delim=",",
        stimOut=params,
        dataOut=["n", "all_mean", "all_std", "all_raw"],
    )
